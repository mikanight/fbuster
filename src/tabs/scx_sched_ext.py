...
class SchedExtSupportSection:
    ...
    def append_to(self, body: Gtk.Box) -> Gtk.Widget:
        ...
        intro.set_subtitle(
            ...
            "с ориентиром на sched_ext (пакет kernel для актуальной линии). "
            "Конкретное имя и версию смотрите в выводе dnf или в репозиториях Fedora. "
    ...
    def _on_install_clicked(self, _btn: Gtk.Button) -> None:
        ...
        dialog = Adw.AlertDialog(
            ...
            body=(
                "Будет запущено обновление индекса dnf и установка пакета ядра, который в Fedora Booster "
